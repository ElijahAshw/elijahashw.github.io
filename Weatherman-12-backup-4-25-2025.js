...
var Screen = (function() {
    ...
    Screen.createButtons = function(buttonConfigs) {
        ...
        // A function that will be bound to create special button onclick functions
        ...
        for (var i = 0; i < buttonConfigs.length; i++) {
            ...
            if (buttonConfig.type === "ButtonArray") {
                ...
                // .bind binds a functions this to its first argument and adds the rest to 
                // the beginning of the function's argument list on future calls
                buttonConfig.onclick = selectButton.bind(null, setNumber, buttonIndex);
