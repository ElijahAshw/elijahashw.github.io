 ...
 *                      ↓
 *                      ↓
 *  (play screen only) Current Level instance ( allLevels[gameState.level] )
 *                      ↓                     ↓
 *                      ↓                     ↓
 ...
 *  When created, a new Screen is passed, among other things, an array of Button configs. It first checks these for a special keyword, 'select<integer>', and replaces this if found. It then creates the Buttons using the configs, and stores them, calling their .mouseClicked and .draw methods for those events. It is what keeps track of selected buttons.
 * 
 * 
 */
...
var allLevelsStored = [
    ...
    /* Level 19 */ [
        ...
        "###########################-#-######################################",
        "--------------------------------------------------------------------",
        {text: "#19. The second-to-last level. Made easy so you can rest.", x: 10, y: 13.5},
        ],
    /* Level 20 */ [
        "#########----------------------------------#",
        "#-------%----------------------------------#",
...
var Static = (function() {
    ...
    Static.createBackground = function(staticElements, text, w, h) {
        ...
        for (var i = 0; i < text.length; i++) {
            ...
            if (!txt.front) {
                backgroundCanvas.textSize(txt.size * blockSize || 15);
...
var Screen = (function() {
    ...
    Screen.createButtons = function(buttonConfigs) {
        ...
        return {selectedButtons: selectedButtons, buttons: buttons, buttonSets: buttonSets};
    };
